...
<head>
  ...
  <style>
    ...
    /* Page header - matching Account_Management.html */
    header.page-header {
      display: flex;
    ...
    .role-citizen { background: #eff6ff; color: #1e40af; }
    .role-responder { background: #fff7ed; color: #9a3412; }
